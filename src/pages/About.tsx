    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <p>
                    Firstly, thank you for visiting The LBC and I truly hope you find it useful. I made this website because I was tired wading through endless unorganised blogs and reddit posts for the best long-listens for my monthly audiobook credits or free trial periods.
                </p>

                <p>
                    We have all been there: You spend your one hard-earned credit on a buzz-worthy new release, only to finish it in a few days of commuting. You are left with weeks of yearning for your next renewal date. I realised that if I wanted real value, I needed to find not only the best, but the longest audio books available.
                </p>

                <p>
                    But this site isn't just about the duration; it's about the immersion. There is a unique magic in a 50+ hour story. It becomes a companion, a world you live in for weeks at a time. Whether it's a sprawling fantasy epic or a definitive biography, I believe the best books are the ones that take their time.
                </p>

                <p>
                    The Long Book Club is my personal passion project to help you find those stories. My goal is simple: to help you maximise your credits, find your next obsession, and get lost in a book that lasts.
                </p>
