...
export const baseBooks: Book[] = [
    ...
    },
    {
        ...
        title: "It",
        author: "Stephen King",
        coverUrl: "/covers/it-stephen-king.jpg",
        length: "44h 57m",
        lengthHours: 45,
    ...
    },
    {
        ...
        coverUrl: "/covers/the-way-of-kings-brandon-sanderson.jpg",
        length: "45h 37m",
        lengthHours: 45.6,
    ...
    },
    {
        ...
        coverUrl: "/covers/sherlock-holmes-the-definitive-collection-arthur-conan-doyle.jpg",
        length: "71h 57m",
        lengthHours: 72,
    ...
    },
    {
        ...
        teaserTitle: "The Foundation of Full-Cast Modern Space Operas",
        teaser: "A 21 hour graphic audio masterclass in world-building that rewards the listener with a fully realised alien culture far beyond the reach of any cinematic adaptation.",
    ...
    },
    {
        ...
        length: "19h 36 hours",
        lengthHours: 19,
        genre: ["Full-Cast", "Urban Fantasy", "Mythology", "Dark Fantasy", "Contemporary Fiction", "Americana", "Mystery", "Adventure", "Cinematic Audio"],
        description: "Shadow Moon is released from prison only to find himself in the middle of a war between old and new gods. A twenty-hour full-cast, cinematic mythic journey.",
        ...
        teaserTitle: "Every Character Voiced with Unique Detail",
        teaser: "Discover the secret heart of America in this twenty-hour masterpiece. This full cast audiobook brings ancient myths to life with a level of detail usually reserved for Graphic Audio Titans, making it a high-yield investment for any listener.",
        cardOverview: "Shadow Moon enters a hidden world where ancient myths live among us. Almost 20 hours of masterful full-cast, cinematic storytelling directed by the author himself.",
    ...
    },
    {
        ...
        coverUrl: "/covers/outlander-diana-gabaldon.jpg",
        length: "32h 38m",
        lengthHours: 32.6,
    ...
    {
        id: "151",
        slug: "the-jane-austen-collection-jane-austen",
        title: "The Jane Austen Collection",
        author: "Jane Austen",
        coverUrl: "/covers/the-jane-austen-collection-jane-austen.jpg",
        length: "45 hours",
        lengthHours: 45,
        genre: ["Cinematic Audio", "Romance", "Classics", "Coming of Age", "Full-Cast", "Graphic Audio", "Family Drama", "Family Saga", "Friendship", "Historical Fiction", "Historical Saga", "Literary Fiction", "Multi-generational", "Obsession", "Redemption", "Regency", "Social Satire", "Sociology", "Tragedy", "UK", "Drama"],
        description: "45 hours of Regency romance. This immersive cinematic audio experience ranks among the best Audible credits 2026. A definitive dramatised audiobooks collection.",
        affiliateLink: "https://www.amazon.co.uk/dp/B08JZGRNBX?tag=thelongbookclub-21",
        affiliateLinkUS: "https://www.amazon.com/dp/B08JY2T245?tag=thelongbookcl-20",
...

    {
        ...
        coverUrl: "/covers/battlefield-earth-l-ron-hubbard.jpg",
        length: "45 hours 53 mins",
        lengthHours: 45.9,
        genre: ["Science Fiction", "Full-Cast", "Aliens", "Addiction", "Adventure", "Dystopian", "Post-Apocalyptic", "Cinematic Audio", "Epic", "Graphic Audio", "Future", "Military"],
        description: "Humankind’s last stand begins in this forty-six-hour epic. Follow Jonnie Goodboy Tyler as he leads a desperate rebellion against the alien Psychlos in a post-apocalyptic wasteland.",
        affiliateLink: "https://www.amazon.co.uk/dp/B01D274V2U?tag=thelongbookclub-21",
        affiliateLinkUS: "https://www.amazon.com/dp/B01D2749JA?tag=thelongbookcl-20",
        teaserTitle: "A Massive Multi-Cast Alien Invasion",
        teaser: "Revisit a classic sci-fi epic through a lens of modern production. This dramatised audiobook features a sprawling cast and cinematic effects, proving why it remains a top choice among Full Cast Audiobooks 2026 for fans of high-stakes survival.",
        cardOverview: "A massive forty-six-hour cinematic production featuring a sixty-five-actor cast. Join the resistance against alien invaders in this monumental dramatised audiobook experience.",
        narrator: "Josh Clark, Corey Burton, Fred Tatascorie, Stefan Rudnicki, Nancy Cartwright, R. F. Daley, Kaleo Griffith, Don Leslie, Ralph Lister, Scott Menville, Jim Meskimen, Tamra Meskimen, Phillip Proctor, Michael Yurchak,"    },
    {
        id: "152",
        ...
        lengthHours: 8.7,
        genre: ["Full-Cast", "Magic School", "Fantasy", "Action", "Coming of Age", "Good vs Evil", "Cinematic Audio", "World Building", "UK", "Adventure", "Graphic Audio", "Magic"],
        description: "A full-cast, cinematic version of the orphaned boy who discovers his magical heritage and attends Hogwarts School of Witchcraft and Wizardry. Harry's journey reboots in this high-production value rendition.",
        affiliateLink: "https://www.amazon.co.uk/dp/B0F155M8K8?tag=thelongbookclub-21",
        affiliateLinkUS: "https://www.amazon.com/dp/B0F14SX2V2?tag=thelongbookcl-20",
        teaserTitle: "The Foundation of a Magical Audio Dynasty",
        teaser: "Begin your journey with the production that set the bar for Graphic Audio Titans. This immersive start to the series proves why dramatised audiobooks are the ultimate way to experience the wizarding world, providing a rich, multi-layered atmosphere that only a full cast can deliver.",
        cardOverview: "The foundational journey into a world of magic, friendship, and danger. Experience the start of the global phenomenon through a spectacular, cinematic full-cast production.",
        narrator: "Hugh Laurie, Matthew Macfadyen, Riz Ahmed, Michelle Gomez, Cush Jumbo, Frankie Treadaway, Max Lester, Arabella Stanton, Mark Addy, Indira Varma, Sacha Dhawan, Nina Wadia, Joel Fry, Adeel Akhtar, Tracy Ann Oberman"
    },
    ...
    {
        id: "153",
        slug: "impact-winter-travis-beacham",
        title: "Impact Winter",
        author: "Travis Beacham",
        coverUrl: "/covers/impact-winter-travis-beacham.jpg",
        length: "4 hours and 55 minutes",
        lengthHours: 4.9,
        genre: ["Post-Apocalyptic", "Full-Cast", "Vampires", "Action", "Cinematic Audio", "Horror", "Survival", "Graphic Audio", "Thriller", "Dystopian", "UK"],
        description: "A world plunged into eternal winter belongs to the vampires. Follow the human resistance in this full-cast, multi-part cinematic audio saga of survival and blood.",
        affiliateLink: "https://www.amazon.co.uk/dp/B09PSLWJNV?tag=thelongbookclub-21",
        affiliateLinkUS: "https://www.amazon.com/dp/B09PSPS2WD?tag=thelongbookcl-20",
...

    {
        ...
        title: "World War Z",
        author: "Max Brooks",
        coverUrl: "/covers/world-war-z-max-brooks.jpg",
        length: "13 hours 56 mins",
        lengthHours: 13.9,
        genre: ["Full-Cast", "Post-Apocalyptic", "Horror", "Action", "Cinematic Audio", "Survival", "War", "Political", "Thriller", "Graphic Audio"],
        description: "An oral history of the zombie apocalypse told by the survivors. This 14-hour star-studded production captures the global collapse and eventual human victory.",
        affiliateLink: "https://www.amazon.co.uk/dp/B00A72QHHQ?tag=thelongbookclub-21",
        affiliateLinkUS: "https://www.amazon.com/dp/B00A6YA5UA?tag=thelongbookcl-20",
...

    {
        ...
        title: "Dracula",
        author: "Bram Stoker",
        coverUrl: "/covers/dracula-audible-edition-bram-stoker.jpg",
        length: "15 hours 27 mins",
        lengthHours: 15.5,
        genre: ["Full-Cast", "Vampires", "Horror", "Dark Fantasy", "Graphic Audio", "Supernatural", "Thriller", "Adventure", "Classics", "Dark Romance", "Good vs Evil", "Gothic", "Historical Horror", "Metaphysical", "Paranormal", "Psychological Thriller", "UK", "Victorian", "London"],
        description: "Lawyer Jonathan Harker visits Count Dracula in Transylvania, unwittingly unleashing an ancient evil upon London in this full-cast, star-studded gothic masterpiece.",
        affiliateLink: "https://www.amazon.co.uk/dp/B007BEILYA?tag=thelongbookclub-21",
        affiliateLinkUS: "https://www.amazon.com/dp/B007B7GOYQ?tag=thelongbookcl-20",
        teaserTitle: "The Definitive Full-Cast, Star-Studded Gothic Archive",
        teaser: "Revisit the origins of the vampire myth in a production that defines the Cinematic Audio Experience. Featuring an A-list cast and Immersive Soundscapes, this collection is an essential listen for those seeking a high-yield investment in classic literature and professional, full-cast dramatisation.",
        cardOverview: "A definitive fifteen hour + performance of the classic vampire tale. Experience Stoker’s masterpiece through an all-star full-cast including Tim Curry and Alan Cumming.",
        narrator: "Alan Cumming, Tim Curry, Simon Vance, Katherine Kellgren, Susan Duerden, John Lee, Graeme Malcolm, Steven Crossley"    },
    {
        id: "156",
        slug: "locke-key-joe-hill",
        title: "Locke & Key",
        author: "Joe Hill",
        coverUrl: "/covers/locke-key-joe-hill.jpg",
        length: "13 hours and 23 minutes",
        lengthHours: 13.4,
        genre: ["Full-Cast", "Graphic Audio", "Dark Fantasy", "Horror", "Magic", "Coming of Age", "Supernatural", "Thriller", "Family Drama"],
        description: "After their father's murder, the Locke children move to Keyhouse, discovering magical keys and a sinister demon in this thirteen-hour, full-cast, cinematic audio epic.",
        affiliateLink: "https://www.amazon.co.uk/dp/B00YI2LFIW?tag=thelongbookclub-21",
        affiliateLinkUS: "https://www.amazon.com/dp/B010PNSBYI?tag=thelongbookcl-20",
